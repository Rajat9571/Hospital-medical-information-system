...
//     { id: 'notifications', label: 'Notifications', icon: Bell, roles: ['admin', 'doctor', 'nurse', 'staff'] },
//     { id: 'settings', label: 'Settings', icon: Settings, roles: ['admin', 'doctor', 'nurse', 'staff'] },
//     // { id: 'approval', label: 'approval', icon: UserRegistrationApproval, roles: ['admin', 'doctor', 'nurse', 'staff'] }
//       // { id: 'approval', label: 'Approvals', icon: ClipboardCheck, roles: ['admin'] }, // ✅ new
